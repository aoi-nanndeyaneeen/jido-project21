...
template <typename Sender, typename Reciver> class IM920SL_Generic {
private:
...
public:
  IM920SL_Generic(HardwareSerial *IM920SL_Serial)
      : _IM920SL_Serial(IM920SL_Serial) {}

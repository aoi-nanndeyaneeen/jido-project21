...
class WaypointMission:
    ...
    #  ★ 2026-09-16: 0.3 -> 0.45 (KD_VEL 0.4 -> 0.45)。正方形1周 (23:59) で
    #    1辺 0.8〜1.0m に 6.4〜12.7秒かかり遅い。モデルでは 0.9m→0.2m 以内が
    #    4.1秒→3.1秒、行き過ぎ 0.11m、保持RMS は同等 (0.10m)。代償は遅れが
    #    1.4倍に増えたときの余裕 (0.14→0.52m)。揺れが戻ったら 0.3/0.4 へ。
    KP_POS = 0.45

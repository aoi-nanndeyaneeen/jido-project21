...
//                        kp      ki      kd
constexpr float RATE_ROLL [3] = { 0.0015f, 0.0f, 0.00004f };
constexpr float RATE_PITCH[3] = { 0.0015f, 0.0f, 0.00004f };
...
constexpr float RATE_D_ALPHA = 0.70f;
...
//                         kp     ki    kd
constexpr float ANG_ROLL [3] = { 6.0f, 0.0f, 0.0f };
constexpr float ANG_PITCH[3] = { 6.0f, 0.0f, 0.0f };
